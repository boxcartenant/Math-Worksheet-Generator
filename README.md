...
The "preview sample" button is mostly for debugging. The sample is not the same as what will be printed. It generates and prints all at once, because I intend for my 6yo son to generate these, solve them, and hand them to me. My intent is to not give him an (easy) way to modify the papers before he prints them.
